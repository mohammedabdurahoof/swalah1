        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">bookfair</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                ...
                                <tbody>
                                    @foreach ($bookfair as $bookfair)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/img/{{ $bookfair->adno }}.jpg" 
                                                class="me-2 rounded-circle prof-img" height="48" width="48">
                                                <p class="m-0 d-inline-block align-middle font-16">
                                                    <a href="{{route('viewStudent',$bookfair->id)}}"
                                                        class="text-body">{{ $bookfair->name }}</a>
                                                    <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('addbookfair') }}" id="addForm">
                    @csrf
                    <div class="mb-3">
