                                ...
                                <tbody>
                                    @foreach ($account as $account)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/img/{{ $account->adno }}.jpg" 
                                                class="me-2 rounded-circle prof-img" height="48" width="48">
                                                <p class="m-0 d-inline-block align-middle font-16">
                                                    <a href="{{route('viewStudent',$account->id)}}"
                                                        class="text-body">{{ $account->name }}</a>
                                                    <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('addaccount') }}" id="addForm">
                    @csrf
                    <div class="mb-3">
